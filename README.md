...
```
Although if you are distributing across multiple computers make sure to only sample from the most recent set of parameters, otherwise it's totally pointless and defeats the purpose of learning.
